  ...
  ...;\n\
    ...
    describe('#renderAST() - file based tests', function() {
        it('should render all arcs', function() {
            var lASTString = fs.readFileSync("./src/script/test/fixtures/test01_all_possible_arcs.json", {
                "encoding" : "utf8"
            });
            var lAST = JSON.parse(lASTString);
            var lExpectedProgram = fs.readFileSync("./src/script/test/fixtures/test01_all_possible_arcs.xu", {
                "encoding" : "utf8"
            });
