    ...
    describe('#renderAST() - mscgen classic compatible - simple syntax tree', function() {
        ...
        it('should, given a simple syntax tree, render an svg', function() {
            jsdom.env("<html><body></body></html>", function(err, window) {
                ...
                var lFixtureString = JSON.stringify(fix.astSimple, null, " ");
                var lFixture = JSON.parse(lFixtureString);
                renderer.renderAST(lFixture, lFixtureString, "__svg", window);
                var lSvg = window.document.body.innerHTML;
