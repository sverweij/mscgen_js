...
SCRIPT_SOURCES_NODE=src/script/render/text/ast2thing.js \
	...
	src/script/ui-control/utl/paramslikker.js
...
SCRIPT_SOURCES_WEB=$(SCRIPT_SOURCES_NODE) \
	...
	src/script/ui-control/interpreter/animator.js \
	src/script/ui-control/utl/exporter.js \
	src/script/ui-control/interpreter/raster-exporter.js \
	src/script/ui-control/utl/store.js \
	src/script/ui-control/utl/gaga.js \
	src/script/ui-control/utl/domutl.js \
...
EMBED_SOURCES_WEB=$(GENERATED_SOURCES_WEB) $(SCRIPT_SOURCES_WEB) \
	...
	src/script/ui-control/embedding/config.js
